...
在你的博客根目录，新建一个 `assets/data/taxonomies` 文件夹路径,然后在里面新建一个配置文件,文件名格式 = `categories.你的分类名.yml`其中内容为title: "博客相关" description: "个人博客搭建与Hugo配置相关笔记" image: "/categories/博客相关.jpg"